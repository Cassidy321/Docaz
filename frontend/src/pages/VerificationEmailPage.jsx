                            ...
                            <div className="bg-secondary p-4 rounded-lg border border-border">
                                <div className="flex items-start space-x-3">
                                    ...
                                    <div className="space-y-1">
                                        <p className="font-medium text-secondary-foreground">Email envoyé à :</p>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="relative space-y-5 pl-10 border-l-2 border-dashed border-primary/30">
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <p className="text-gray-700">Vérifiez votre boîte de réception (et les spams).</p>
                                    </div>
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <p className="text-gray-700">Cliquez sur le lien pour activer votre compte.</p>
                                    </div>
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <p className="text-gray-700">Connectez-vous pour commencer !</p>
                                    </div>
                                </div>
                            </div>
