                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3 md:gap-6">
                        ...
                        {!isAuthenticated ? (
                            ...
                            >
                                <div className="relative p-1.5 rounded-full group-hover:bg-primary/10 transition-colors duration-200">
                                    <div className="w-6 h-6 rounded-full bg-primary text-white flex items-center justify-center text-xs font-medium group-hover:scale-110 transition-transform duration-200 shadow-sm">
                                        {getUserInitial()}
                                    </div>
                                </div>
